...
<body>
	<header>
		<nav class="navbar navbar-light bg-light">
			<span class="navbar-brand mb-0 h1" style="font-weight: bold;">Editar Pessoa </span><a href="main" class="btn btn-primary" role="button">Listar
		</a>
		</nav>
	</header>
	...
	<form name="form" action="update"
		...
		<button type="submit" onclick="validar()" class="btn btn-primary"
			style="margin-top: 10px; margin-right: 84%; width: 20%;">Salvar</button>
	</form>
