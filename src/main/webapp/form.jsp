...
<head>
<meta charset="UTF-8">
<title>Register of People</title>
<link rel="stylesheet"
	...
	<form  name="form" action="insert"
		...
		<div class="col-sm-1">
			<label class="visually-hidden" for="autoSizingInput">Id</label> <input
				type="text" class="form-control" id="autoSizingInput"  name="id" readonly="readonly">
		</div>


		<div class="col-sm-5">
			<label class="visually-hidden" for="autoSizingInput">Name</label> 
			<input type="text" class="form-control"	id="autoSizingInput" placeholder="João Silva" 
